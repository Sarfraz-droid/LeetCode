<h2>1130. Minimum Cost Tree From Leaf Values</h2><h3>Medium</h3><hr><div><p>Given an array <code>arr</code> of positive integers, consider all binary trees such that:</p>
